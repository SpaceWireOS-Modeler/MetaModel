...
/**
 * This is the item provider adapter for a {@link jp.pizzafactory.model.spacewireos.networkTopology.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetworkTopologyPackage.Literals.NODE__PORT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Node.class)) {
			case NetworkTopologyPackage.NODE__PORT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetworkTopologyPackage.Literals.NODE__PORT,
