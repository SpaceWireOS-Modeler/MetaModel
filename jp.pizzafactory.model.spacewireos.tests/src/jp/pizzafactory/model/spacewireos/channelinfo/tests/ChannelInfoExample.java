...
import jp.pizzafactory.model.spacewireos.channelinfo.util.ChannelInfoResourceFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>channelinfo</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new ChannelInfoResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(ChannelInfoPackage.eNS_URI, 
			 ChannelInfoPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.swosci")); //$NON-NLS-1$
				DocumentRoot documentRoot = ChannelInfoFactory.eINSTANCE.createDocumentRoot();
				SpaceWireChannelInfo root = ChannelInfoFactory.eINSTANCE.createSpaceWireChannelInfo();
				documentRoot.setSpaceWireChannelInfo(root);
