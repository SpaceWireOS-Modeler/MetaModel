 ...
 * <ul>
 *   <li>{@link jp.pizzafactory.model.spacewireos.networkTopology.impl.DeviceImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DeviceImpl extends MinimalEObjectImpl.Container implements Device {
	...
	protected EClass eStaticClass() {
		return NetworkTopologyPackage.Literals.DEVICE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkTopologyPackage.DEVICE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NetworkTopologyPackage.DEVICE__ID:
				return getId();
		}
