 ...
 * @generated
 */
public class NetworkTopologySwitch<T> extends Switch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NetworkTopologyPackage.FDIR: {
				FDIR fdir = (FDIR)theEObject;
				T result = caseFDIR(fdir);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case NetworkTopologyPackage.NODE: {
				...
				if (result == null) result = caseDevice(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkTopologyPackage.NODE_PORT: {
				NodePort nodePort = (NodePort)theEObject;
				T result = caseNodePort(nodePort);
				if (result == null) result = casePort(nodePort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case NetworkTopologyPackage.SPACE_WIRE_NETWORK_TOPOLOGY: {
				SpaceWireNetworkTopology spaceWireNetworkTopology = (SpaceWireNetworkTopology)theEObject;
				T result = caseSpaceWireNetworkTopology(spaceWireNetworkTopology);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FDIR</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FDIR</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFDIR(FDIR object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Node Port</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Node Port</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNodePort(NodePort object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Space Wire Network Topology</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Space Wire Network Topology</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpaceWireNetworkTopology(SpaceWireNetworkTopology object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Timeslot</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Timeslot</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
