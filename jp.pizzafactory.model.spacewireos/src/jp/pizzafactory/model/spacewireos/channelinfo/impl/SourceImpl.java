 ...
 * <ul>
 *   <li>{@link jp.pizzafactory.model.spacewireos.channelinfo.impl.SourceImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourceImpl extends MinimalEObjectImpl.Container implements Source {
	...
	protected EClass eStaticClass() {
		return ChannelInfoPackage.Literals.SOURCE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChannelInfoPackage.SOURCE__ID, oldId, id));
	}
